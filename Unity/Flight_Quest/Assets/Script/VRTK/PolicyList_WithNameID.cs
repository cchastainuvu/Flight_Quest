...
namespace VRTK
{
    ...
    /*SKYE"S NOTES
        I want to eventually change this script so that the policylist can include nameid as an input
    */
    ...
    /// </remarks>
    [AddComponentMenu("VRTK/Scripts/Utilities/VRTK_PolicyListNameID")]
    public class PolicyList_WithNameID : MonoBehaviour
    {
        /// <summary>
        ...
        public enum CheckTypes
        {
            ...
            Layer = 4,
            /// <summary>
            /// A NameID applied to the game object.
            /// </summary>
            NameID = 8
        }
        ...
        protected virtual bool TypeCheck(GameObject obj, bool returnState)
        {
            ...
            if(((int)checkType & (int)CheckTypes.NameID) != 0)
            {
                selection += 8;
            }
